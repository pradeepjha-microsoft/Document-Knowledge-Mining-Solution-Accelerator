...
//   OptionsPanel: jest.fn((props: any) => <div data-testid="options-panel" >
...
describe("ChatRoom Component", () => {
    ...
    it.skip("toggles Feedback Form visibility", () => {
      ...
      it("renders conversation answers correctly", async () => {
        ...
        await waitFor(()=>{
        expect(screen.getByText(/Selected/i))
        expect(screen.getByText(/Chat with documents/i))
        expect(screen.queryByTestId("mock-copilot-provider")).toBeInTheDocument();
        expect(screen.queryByTestId("mock-copilot-chat")).toBeInTheDocument();
      })
    });
